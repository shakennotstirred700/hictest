...
import (
	...
	dexmodule "hictest/x/dex"
	dexmodulekeeper "hictest/x/dex/keeper"
	dexmoduletypes "hictest/x/dex/types"
	hictestmodule "hictest/x/hictest"
	hictestmodulekeeper "hictest/x/hictest/keeper"
	hictestmoduletypes "hictest/x/hictest/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "hictest/app/params"
	"hictest/docs"
)
...
type App struct {
	*baseapp.BaseApp
	...
	HictestKeeper   hictestmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.HictestKeeper = *hictestmodulekeeper.NewKeeper(
		appCodec,
		keys[hictestmoduletypes.StoreKey],
		keys[hictestmoduletypes.MemStoreKey],
		app.GetSubspace(hictestmoduletypes.ModuleName),
	)
	hictestModule := hictestmodule.NewAppModule(appCodec, app.HictestKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(hictestmoduletypes.ModuleName)
